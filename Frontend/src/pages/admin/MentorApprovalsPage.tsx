          ...
          <div className="relative z-10 flex items-center justify-between gap-3">
            <div>
              <div className="flex items-center gap-1.5 mb-1">
                <span className="material-symbols-outlined text-pink-400 text-base">how_to_reg</span>
                <span className="text-pink-500 text-[10px] font-bold uppercase tracking-widest">Admin · Mentor Review</span>
              </div>
              <h1 className="text-xl font-extrabold tracking-tight text-rose-900">Mentor Approvals</h1>
              <p className="text-rose-600 text-xs mt-0.5">Review and manage pending mentor applications</p>
              {!isLoading && (
                <span className="mt-1.5 inline-block text-[10px] font-bold bg-pink-200/60 text-pink-700 px-2 py-0.5 rounded-full border border-pink-300/40">
                  {totalElements} pending application{totalElements !== 1 ? 's' : ''}
                </span>
              )}
            </div>
            <span className="material-symbols-outlined text-pink-200 text-[52px] shrink-0 hidden md:block">pending_actions</span>
          </div>
        </div>
